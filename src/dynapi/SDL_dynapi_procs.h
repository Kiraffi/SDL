...
SDL_DYNAPI_PROC(bool,CARP_SDL_GetGPUTimestampProperties,(SDL_GPUDevice *a,CARP_SDL_GPUTimestampProperties *b),(a,b),return)
SDL_DYNAPI_PROC(CARP_SDL_GPUTimestampQueryPool*,CARP_SDL_CreateGPUTimestampQueryPool,(SDL_GPUDevice *a,Uint32 b),(a,b),return)
SDL_DYNAPI_PROC(void,CARP_SDL_ReleaseGPUTimestampQueryPool,(SDL_GPUDevice *a,CARP_SDL_GPUTimestampQueryPool *b),(a,b),)
SDL_DYNAPI_PROC(bool,CARP_SDL_WriteGPUTimestamp,(SDL_GPUCommandBuffer *a,CARP_SDL_GPUTimestampQueryPool *b,Uint32 c),(a,b,c),return)
SDL_DYNAPI_PROC(bool,CARP_SDL_CopyGPUTimestampResults,(SDL_GPUCopyPass *a,CARP_SDL_GPUTimestampQueryPool *b,Uint32 c,Uint32 d,SDL_GPUBuffer *e,Uint32 f),(a,b,c,d,e,f),return)
