...
static bool METAL_GetGPUTimestampProperties(
    SDL_GPUDevice *device,
    CARP_SDL_GPUTimestampProperties *outProperties)
{
    (void)device;
    (void)outProperties;
    return SDL_SetError("Metal GPU timestamp queries are unsupported by this extension");
}

static void *METAL_CreateGPUTimestampQueryPool(
    SDL_GPUDevice *device,
    Uint32 queryCount)
{
    (void)device;
    (void)queryCount;
    SDL_SetError("Metal GPU timestamp queries are unsupported by this extension");
    return NULL;
}

static void METAL_ReleaseGPUTimestampQueryPool(
    SDL_GPUDevice *device,
    void *queryPool)
{
    (void)device;
...
static bool METAL_WriteGPUTimestamp(
    SDL_GPUCommandBuffer *commandBuffer,
    void *queryPool,
    Uint32 queryIndex)
{
...
static bool METAL_CopyGPUTimestampResults(
